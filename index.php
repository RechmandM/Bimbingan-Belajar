...
if (isset($_SESSION['us']) && $_SESSION['login'] == true) {
?>
    ...
    <head>
        ...
        <title>Bimbingan Belajar By Rechmand M</title>
    ...
    <body data-bs-spy="scroll" data-bs-target="#sidebarMenu" data-bs-offset="200">
        ...
        <div class="container-fluid">
            <div class="row" style="background-image: url('./assets/img/kelas.jpg'); background-repeat: repeat; background-size:auto;">
                <!----------------------------- SIDEBAR MENU -------------------------------->
